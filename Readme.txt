...
STEPS TO RUN WEBAPP:
	...
	-Install MS SQL-Server Management Studio 2012
	-Open SQl-SERVER,connect to the Server and Run the DB creation script MarketPlaceDB which will create database,tables,sequences and procedures that are used in 	 project
	-Run all the commands except create procedure, run it one-by-one
